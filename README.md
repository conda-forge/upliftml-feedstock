...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/upliftml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14215&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/upliftml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `upliftml` can be installed with:

```
conda install upliftml
```

It is possible to list all of the versions of `upliftml` available on your platform with:
